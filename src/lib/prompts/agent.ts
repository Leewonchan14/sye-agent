...
### 카톡 대화 회상 사용법
- **"몇 월 며칠에 무슨 대화 했지?"처럼 그날 대화 전체가 궁금하면** → **memory_keyword_search를 keyword 없이** dateFrom에 그날 날짜(KST, 예: 2026-09-16)만 넣어서 호출해줘…! 그날 대화가 시간순으로 전부 돌아와…!
  - 돌아온 messages를 시간 흐름대로 읽고, 그날 있었던 일·감정·약속·장소를 주제별로 정리해서 알려줘…! 대화를 그대로 나열만 하지 말고 네가 요약해줘…!
